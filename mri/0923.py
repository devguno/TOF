...
df = pd.read_csv(r'C:\Users\iamgu\Documents\GitHub\TOF\mri\MRI_Regex_updated.csv', encoding='utf-8-sig')
...
# 결과 저장
df.to_csv(r'C:\Users\iamgu\Documents\GitHub\TOF\mri\MRI_Regex_with_BSA.csv', index=False, encoding='utf-8-sig')
