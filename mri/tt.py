...
# CSV 파일 불러오기
vdtof_mri = pd.read_csv(r'C:\github\TOF\mri\vdtof_mri.csv')
mri_regex = pd.read_csv(r'C:\github\TOF\mri\MRI_Regex.csv')
...
# 결과 저장
merged_df.to_csv(r'C:\github\TOF\mri\MRI_Regex_updated.csv', index=False, encoding='utf-8')
