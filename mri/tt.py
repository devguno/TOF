...
# CSV 파일 불러오기
vdtof_mri = pd.read_csv(r'C:\Users\iamgu\Documents\GitHub\TOF\mri\vdtof_mri.csv', encoding='utf-8-sig')
mri_regex = pd.read_csv(r'C:\Users\iamgu\Documents\GitHub\TOF\mri\MRI_Regex.csv', encoding='utf-8-sig')
...
# 결과 저장
merged_df.to_csv(r'C:\Users\iamgu\Documents\GitHub\TOF\mri\MRI_Regex_updated.csv', index=False, encoding='utf-8-sig')
